...
const History = () => {
  return (
    <section className="w-full justify-center items-center flex flex-col p-3 bg-green-50">
      <div className="max-w-7xl  w-full flex flex-col">
        <h1 className="text-3xl md:text-5xl font-bold text-green-700 mb-4">
          History
        </h1>
        <div className=" w-full grid grid-cols-2 md:text-2xl md:flex md:flex-row py-2 gap-5 md:gap-10 text-black">
          {[1, 2, 3].map((p) => (
