...
export default function DataInputForms() {
  ...
  //     }
  //   };
  const { handleBlur: handlePlayerBlur } = useFieldValidation(
    playerSchema,
    player,
    setPlayerErrors
  );
  const { handleBlur: handleNewsBlur } = useFieldValidation(
    newsSchema,
    news,
    setNewsErrors
  );
  const { handleBlur: handleticketBlur } = useFieldValidation(
    ticketSchema,
    ticket,
    setTicketErrors
  );
